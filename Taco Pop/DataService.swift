...
class DataService {
    ...
    func loadDeliciousTacoData() {
        ...
        tacoArray.append(Taco(id: 2, productName: "Plain Flour Chicken Taco", shellId: 1, proteinId: 2, condimentId: 2))
        ...
        tacoArray.append(Taco(id: 6, productName: "Loaded Corn Beed Taco", shellId: 2, proteinId: 1, condimentId: 1))
